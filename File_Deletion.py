...
repo = "Project_CDAC"
branch = "main"
path = "Project_CDAC/Data_Updation"
github_token = "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"

# Function to delete files from GitHub after data is loaded
def delete_files_from_github():
    api_url = f"https://api.github.com/repos/kartikcdac/Project_CDAC/contents/Data_Updation?ref=main"
    ...
    for file in files:
        if file['name'].endswith('.csv'):
            delete_url = f"https://api.github.com/repos/kartikcdac/Project_CDAC/contents/Data_Updation/{file['name']}"
